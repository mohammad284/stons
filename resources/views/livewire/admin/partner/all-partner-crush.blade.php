<div>
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">شركات المقلع</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
              <li class="breadcrumb-item active">شركات المقلع</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="d-flex justify-content-between mb-2">
                <button wire:click.prevent="addNew"  class="btn btn-primary"><i class="fa fa-plus-circle mr-1"></i> إضافة شريك للمقلع</button>
            </div>
            <div class="card">
              <div class="card-body">
    ...
    <form wire:submit.prevent="{{$showEditModal ? 'updatePartner': 'createPartner'}}">
        ...
        <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="email">النسبة</label>
                    <input type="text" wire:model.defer='state.percentage' class="form-control @error('percentage') is-invalid @enderror" id="percentage" aria-describedby="emailHelp" placeholder="Enter percentage">
                    @error('percentage')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
