<div>
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">مصاريف المقلع</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
              <li class="breadcrumb-item active">مصاريف المقلع</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <table class="table table-hover">
                    ...
                    @foreach($expenses as $expense)
                        ...
                        <td>{{$expense->payments}}</td>
                        <td>{{$expense->statment}}</td>
                        <td>{{$expense->date}}</td>
                        <td>
                            <a href="" wire:click.prevent="edit({{ $expense}})">
                                <i class="fa fa-edit mr-2"></i> 
                            </a>
                            <a href="" wire:click.prevent="confirmUserRemove({{$expense->id}})"><i class="fa fa-trash text-danger"></i> </a>
                        </td>
                        @endforeach
                    </tbody>
                </table>
            ...
            <div class="modal-body">
                    <div class="form-group">
                      <div class="col-sm-12">
                        ...
                        <div class="form-group">
                          <label>الشريك</label>
                          <select class="form-control" wire:model.defer="state.partner_id" id="subject">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" wire:model.defer='state.payments' class="form-control @error('payment') is-invalid @enderror" id="payment" aria-describedby="emailHelp" placeholder="Enter payment">
                        @error('payment')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
